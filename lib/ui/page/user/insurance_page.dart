...
class InsurancePage extends StatelessWidget {
        ...
        Expanded(
            child: ListView(
              children: <Widget>[
                ...
                _buildItem(context,'中医师执业保险','为充分保障注册中医师合法权益，一经通过本平台审核，本平台将为注册中医师的线下诊疗活动提供最高保额为【500】万元的医疗责任事故保险。并且，在必要时间向注册中医师提供法律咨询和法律援助信息，为本平台注册中医师提供全方位、多角度的协助与支持',centerTitle: true),
  ...
  Widget _buildItem(BuildContext context,String title,String content,{bool centerTitle = false}) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(title, style: TextStyle(fontSize: ScreenUtil().setSp(16), color:  Theme.of(context).primaryColor)),
          SizedBox(height: ScreenUtil().setWidth(15)),
          Text(content,style: TextStyle(fontSize: ScreenUtil().setSp(14)))
        ],
      ),
    );
  }
