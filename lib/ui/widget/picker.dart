...
class Picker {
  ...
  final Color backgroundColor, containerColor;
  final bool looping;
...
class DateTimePickerAdapter extends PickerAdapter<DateTime> {
  ...
  static const List<String> MonthsList = const [
    "1月",
    "2月",
    "3月",
    "4月",
  ...
  @override
  String getText() {
    return type == 11 ?'${value.year}-${value.month}':value.toString();
  }
